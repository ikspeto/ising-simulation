...
def metropolis(N, T, n, B1):
	...
	for i in range(int(n/5)):
		res = ising(N, T, B)
		Ms[i] = numpy.float32(res[0])/numpy.float32(N*N)
	...
	plt.savefig('hysteresis,N='+str(N)+',n='+str(n)+',t='+str(T)+'.png')
	...
	h5f = h5py.File('hysteresis,N='+str(N)+',n='+str(n)+',t='+str(T)+'.h5', 'w')
